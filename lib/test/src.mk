...
test += $(dir)/op-nop
test += $(dir)/op-query-board
test += $(dir)/op-query-board-corrupt
test += $(dir)/op-query-board-readlink-fail
test += $(dir)/op-query-id
test += $(dir)/op-query-id-fail
test += $(dir)/op-query-id-map
